...
public interface ApiService {
	...
	@GET("/bikes")
	public void getBikes(@Header("X-Api-Key") String token, @Query("lat") String lat, @Query("lng") String lng,/*@Path("lat") double lat, @Path("lng") double lng,*/ Callback<List<Bike>> bikesCallback);
}
